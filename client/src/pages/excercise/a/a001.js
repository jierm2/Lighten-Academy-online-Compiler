  ...
  return (
    <div>
      ...
      <div className="container mt-4 letter">
        <p>
          Today, we're going to write a special message using code. Your task is to modify the code so that it prints the message "<span style={{ backgroundColor: 'gray' }}>Howdy, world!</span>" on the screen.
        </p>
        <p>
